...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        List<Graph.Edge<Integer>> path = aStar.aStar(grafo.graph, grafo.v1, grafo.v8);

        int initialNode = grafo.v1.getValue();
        int finalNode = grafo.v8.getValue();
        ...
        List<Graph.Edge<Integer>> path2 = aStar2.aStar(grafo2.graph, grafo2.v1, grafo2.v8);

        int initialNode2 = grafo2.v1.getValue();
        int finalNode2 = grafo2.v8.getValue();
